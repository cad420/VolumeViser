...
int main(int argc, char** argv){
    auto dev = cub::cu_physical_device::get_all_device().front();
    auto ctx = dev.create_context(0);
    void* params[] = {nullptr};
    cub::cu_kernel_launch_info info;
    cudaLaunchKernel((const void*)&TestKernel,
                     dim3{1,1,1},
                     dim3{16,16,16},
                   params);
    return 0;
