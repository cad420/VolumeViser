...
VUTIL_BEGIN
    ...
    namespace keycode_table{

        inline constexpr keycode_t KEY_UNKNOWN = -1;

        inline constexpr keycode_t KEY_SPACE = 32;
        inline constexpr keycode_t KEY_APOSTROPHE = 39; // '
        inline constexpr keycode_t KEY_COMMA      = 44; // ,
        inline constexpr keycode_t KEY_MINUS      = 45; // -
        inline constexpr keycode_t KEY_PERIOD     = 46; // .
        inline constexpr keycode_t KEY_SLASH      = 47; // /
