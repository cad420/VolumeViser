...
VUTIL_BEGIN
    ...
    ttransform3<T, C>::ttransform3(uninitialized_t) noexcept
            : mat_(uninitialized_t{}), inv_(uninitialized_t{})
    {
    ...
    {
        return self_t(
                mat_t::left_transform::translate(offset),
                mat_t::left_transform::translate(-offset));
    }
    ...
    {
        return self_t(
                mat_t::left_transform::translate(x, y, z),
                mat_t::left_transform::translate(-x, -y, -z));
    }
    ...
    {
        return self_t(
                mat_t::left_transform::rotate(axis, rad),
                mat_t::left_transform::rotate(axis, -rad));
    }
    ...
    {
        return self_t(
                mat_t::left_transform::rotate_x(rad),
                mat_t::left_transform::rotate_x(-rad));
    }
    ...
    {
        return self_t(
                mat_t::left_transform::rotate_y(rad),
                mat_t::left_transform::rotate_y(-rad));
    }
    ...
    {
        return self_t(
                mat_t::left_transform::rotate_z(rad),
                mat_t::left_transform::rotate_z(-rad));
    }
    ...
    {
        return self_t(
                mat_t::left_transform::scale(x, y, z),
                mat_t::left_transform::scale(1 / x, 1 / y, 1 / z));
    }
    ...
    {
        const auto v4 = inv_.transpose() * tvec4<T>(normal.x, normal.y, normal.z, 0);
    ...
    {
        const auto v4 =
                (mat_.transpose() * tvec4<T>(normal.x, normal.y, normal.z, 0)).normalize();
        return tvec3<T>(v4.x, v4.y, v4.z).normalize();
    }
