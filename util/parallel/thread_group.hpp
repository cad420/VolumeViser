...
#include "time/timeline_trace_file.hpp"
 ...
 */
        struct task_deps_t: intrusive_ptr_enabled_t<task_deps_t,task_deps_deleter_t,multi_thread_counter>{
            ...
            std::vector<intrusive_ptr_t<task_deps_t>> pending_deps;
        ...
        using task_deps_handle_t = intrusive_ptr_t<task_deps_t>;
 ...
 */
    struct task_group_t : intrusive_ptr_enabled_t<task_group_t,detail::task_group_deleter_t,multi_thread_counter>{
    ...
    using task_group_handle_t = intrusive_ptr_t<task_group_t>;

    class thread_group_t final : no_move_t{
    public:
        thread_group_t();
        ~thread_group_t();
        ...
        timeline_trace_file_t* get_timeline_trace_file();
    ...
    private:
        ...
        thread_safe_object_pool_t<detail::task_t> task_pool;
        thread_safe_object_pool_t<task_group_t> task_group_pool;
        thread_safe_object_pool_t<detail::task_deps_t> task_deps_pool;
        ...
        std::unique_ptr<timeline_trace_file_t> timeline_trace_file;
    };
